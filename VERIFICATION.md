...
Review artifact: `Design/037-Drawer-Copy-Review-2026-09-10-v5/Review.html`. Actual DAW-host copying/resize verification and release builds remain pending. These changes prevent the reproduced reset; they do not reconstruct audio or edits already absent from a saved instance.
