...
Mac ZIP verification passed CRC, clean installation, replacement/backup, complete payload identity, universal architectures, signatures, versions and corrupt-payload rejection. ZIP SHA-256: `9de4ee4c73c7bbf8031131dfc3e344d00cab4dfe92220f862c975c8ea6026cfa` (33,659,938 bytes). Per-user AU/VST3 0.3.10 are installed, match staging exactly and pass strict signature checks and AU validation. No system-wide duplicates were found. Previous bundles: `~/Library/Application Support/Rango Labs/MoteField/Backups/install-s3qVLpYu`. Actual DAW playback/listening remains a beta validation item. GitHub [run 34670756399](https://github.com/rangoxlabs/motefield/actions/runs/34670756399) passed for macOS and Windows at `3ca2070`. Windows checks include native x64 compilation, DSP/click suites, ZIP clean install/replacement/corruption tests and installer/uninstaller verification. Downloaded ZIP checksum, CRC, complete payload hashes, module version and x64 PE architecture passed; the installer checksum also matched. Windows ZIP SHA-256: `7616c2bde6573fe295d811408130ae4bec2538ad8a6761f0150dddc207a8582c` (8,397,069 bytes). Both sharing ZIPs include installation instructions.
