...
Version **0.2.6** builds as universal macOS VST3, AU, and standalone targets. The VST3 and AU have been installed locally, and Apple AU validation passed. See [VERIFICATION.md](VERIFICATION.md) for test coverage.
